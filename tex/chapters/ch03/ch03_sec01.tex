...
\end{equation}
which is well defined only when $\chi \neq \emptyset$. In particular, the value is zero whenever $l \in \chi$, and otherwise it equals the smallest distance from $l$ to any alphabet in $\chi$.
...
framework in which execution and planning are interleaved. The essential requirement is that the robot
...
$Q'_{\tau_{\textup{past}}}$.
The local revision idea is as follows. Rather
