...
is defined by the state and control costs introduced above.
...
using the same trajectory-cost surrogate,
...
trajectories, they can be incorporated into the task evaluation by~\eqref{ch06:eq:state-cost-sequential},
