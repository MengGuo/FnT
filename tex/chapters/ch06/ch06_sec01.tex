...
generally incompatible on the same infinite execution. Related MDP and temporal
logic background is given in Chapter~\ref{ch02:chap:preliminaries}; see in
...
task-level abstraction. The overall structure is illustrated in
Fig.~\ref{ch06:fig:proposed_framework}.
...
\(S'_{\textup{\texttt{r}},\Xi}\). The execution structure is shown in
Fig.~\ref{ch06:fig:execution}.
