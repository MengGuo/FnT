...
particular Section~\ref{ch02:sec:LTL} and
Sections~\ref{ch02:subsec:NBA}--\ref{ch02:subsec:product}.
...
are recalled in Section~\ref{ch02:sec:LTL}. The automata-based synthesis used
later follows the same overall paradigm as in
Sections~\ref{ch02:subsec:NBA}--\ref{ch02:subsec:product}, with deterministic
...
throughout the remainder of Section~\ref{ch06:sec:ch06_safe_plan}.
...
Section~\ref{ch06:subsec:complexity}. Since the safe-return specification is of
