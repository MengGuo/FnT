...
Note that~$\mathcal{B}_{\varphi}$ has the structure as defined in Def.~\ref{ch02:def:NBA},
...
The NBA~$\mathcal{B}_{\varphi}$ associated with the task formula in~\ref{ch04:example:subtask}
...
On the contrary, as described in the multi-agent setting,
